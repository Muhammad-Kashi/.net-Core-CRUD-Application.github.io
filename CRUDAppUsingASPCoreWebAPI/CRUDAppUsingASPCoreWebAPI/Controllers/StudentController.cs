...
namespace CRUDAppUsingASPCoreWebAPI.Controllers
{
    public class StudentController : Controller
    {
        ...
        {
            string data = JsonConvert.SerializeObject(std); //std convert into JSON
            StringContent content = new StringContent(data, Encoding.UTF8, "application/json"); //Json convert into String Content mean formated Test
